        ...
        <div class="flex">
            ...
            <div class="flex space-x-0 h-screen bg-whitex" style="width: 90%;">
                <div style="margin-top: 28%; margin-left: 13%;">
                    ...
                    <p class="text-4xl font-bold ">Buat akun anda:</p>
                    <form id="loginForm" action="register.php" method="post">
                        ...
                        <button type="submit" name="submit" class="bg-opacity-50 pt-1 pb-1 pl-4 pr-4 bg-slate-400 rounded-xl hover:text-white hover:bg-slate-700">Register</button>
                    </form>
                    <br>
                    <p>Sudah memiliki akun? <a href="login.php" style="text-decoration: underline; color: blue;">Login!</a></p>
